...
const SUB_AREA_ALIAS_MAP = new Map<string, string>([
    ['bgb at', 'BGB AT'],
    ['bgb at 1', 'BGB AT'],
    ['bgb at 2', 'BGB AT'],
    ['bgb at 3', 'BGB AT'],
...
export const normalizeLegalArea = (value: string | undefined): string | undefined => {
    if (!value) {
        return undefined;
    }
...
export const normalizeSubArea = (value: string | undefined): string | undefined => {
    if (!value) {
        return undefined;
    }
    const slug = slugify(value);
