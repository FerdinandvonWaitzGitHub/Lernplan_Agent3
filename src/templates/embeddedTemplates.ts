...
interface EmbeddedTemplateFile {
    id: string;
    fileName: string;
    raw: unknown;
}

const makeEntry = (fileName: string, raw: unknown): EmbeddedTemplateFile => ({
 ...
 */
export const EMBEDDED_TEMPLATE_FILES: EmbeddedTemplateFile[] = [
